...
HEAD      = "/Users/elenag/Desktop/ORNL/ORNL/"+SUBFOLDER+"/%s/" % TEMP 
...
for FOLDER in FOLDERS:
    ...
    w = (w.split("_"))[1]
    try:
        print(labels[0],int((labels[1])[:-1]),int(w), area, lowerBound, upperBound, Data[counter].X[lowerBound], Data[counter].X[upperBound])
    except ValueError:
        x=1
